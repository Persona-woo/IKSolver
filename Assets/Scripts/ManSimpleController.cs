...
/// </summary>
[RequireComponent(typeof(ManLegStepper))]
public class ManSimpleController : MonoBehaviour
{
    ...
    private ManLegStepper legStepper;

    void Awake()
    {
        legStepper = GetComponent<ManLegStepper>();
    }
